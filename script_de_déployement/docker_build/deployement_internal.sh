...
docker run -d --rm --name=host-web --net=wt --ip=172.20.12.2 --dns=172.20.0.2  host-web /bin/bash -c "while :; do sleep 10; done"
docker run -d --rm --name=host-mail --net=wt --ip=172.20.13.2 --dns=172.20.0.2  host-mail
